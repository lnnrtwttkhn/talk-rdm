...
knitr::include_graphics("https://raw.githubusercontent.com/datalad-handbook/artwork/master/src/publishing/clone_local.svg")
```
]
...
knitr::include_graphics("https://raw.githubusercontent.com/datalad-handbook/artwork/master/src/publishing/clone_server.svg") 
```
]
...
.pull-right[
```{r, echo=FALSE, fig.align="center", out.width="50%", fig.retina=1, fig.cap='<a href="https://wiki.seg.org/wiki/Jon_Claerbout" target="_blank">Jon Claerbout</a></br>Geophysicist at Stanford University</br>(CC-BY-SA)'}
knitr::include_graphics("https://sepwww.stanford.edu/sep/prof/myface1.jpg") 
```
]
