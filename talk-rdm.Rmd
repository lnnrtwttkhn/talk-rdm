...
- GitLab (and GitHub) allow setting the **project and group visibility**
  - GitLab visibility levels: `Private` `r emoji::emoji("new_moon")` `Internal` `r emoji::emoji("first_quarter_moon")` `Public` `r emoji::emoji("full_moon")` (details [here](https://docs.gitlab.com/ee/user/public_access.html))
