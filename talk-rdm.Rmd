...
- a bouquet of ideas for your own research workflow `r emoji::emoji("bouquet")`
- suggestions for research data management at an institutional level `r emoji::emoji("school")` 
...
- Nested subdatasets look and feel just like a normal (sub-)directories in your project
{{content}}
]
...
- Lower-level datasets ("subdatasets") have an independent stand-alone history
- The top-level "superdataset" only stores *which version* of the subdataset is currently used
- This enables **modularity** `r emoji::emoji("sparkles")`
{{content}}
