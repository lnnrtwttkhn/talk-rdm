...
- know exactly what was changed when and by whom
- You don't loose any changes (unless you try really hard)
- **Branches**: parallel versions
- keep working version 
- collaboration 
- when using GitLab & GitHub you always have at least one backup of your code
