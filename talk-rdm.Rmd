...
- Rendered presentation publicly available via
- Source code publicly available on GitHub
- This presentation contains links to external resources. I do not take responsibility for the accuracy, legality or content of the external site or for that of subsequent links.
- I am happy for any feedback or suggestion via [email](mailto:wittkuhn@mpib-berlin.mpg.de) or [GitHub issues](https://github.com/lnnrtwttkhn/talk-rdm/issues). Thank you! 🙏
...
#knitr::include_graphics("input/figures/figure1_part5.png") 
```
...
```{r, echo=FALSE, fig.align="center", out.width="75%", fig.retina=1, fig.cap="https://doi.org/10.1038/s41467-021-21970-2"}
#knitr::include_graphics("input/figures/screenshot_wittkuhn_schuck_natcomms.png") 
```
...
```{r, echo=FALSE, fig.align="center", out.width="10%", fig.retina=1, fig.cap="https://gin.g-node.org/"}
...
```{r, echo=FALSE, fig.align="center", out.width="60%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/101-138-sharethirdparty.html"}
...
- Free, open-open source **command-line tool**
...
- I'm "only" an enthusiastic user of DataLad! 😊
...
```{r, echo=FALSE, fig.align="center", out.width="40%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/101-101-create.html"}
...
```{r, echo=FALSE, fig.align="center", out.width="40%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/101-107-summary.html"}
...
```{r, echo=FALSE, fig.align="center", out.width="60%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/101-120-summary.html"}
knitr::include_graphics("http://handbook.datalad.org/en/latest/_images/collaboration.svg") 
```

---

# DatLad: Dataset linkage

> *"Datasets can contain other datasets (subdatasets), nested arbitrarily deep."*

```{r, echo=FALSE, fig.align="center", out.width="70%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/101-106-nesting.html"}
...
```{r, echo=FALSE, fig.align="center", out.width="50%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/101-113-summary.html"}
...
```{r, echo=FALSE, fig.align="center", out.width="50%", fig.retina=1, fig.cap="http://handbook.datalad.org/en/latest/basics/basics-thirdparty.html"}
...
```{r, echo=FALSE, fig.align="center", out.width="90%", fig.retina=1, fig.cap="http://docs.datalad.org/en/stable/metadata.html"}
...
- moving towards a "culture of reproducibility" (cf. Russ Poldrack, see e.g., [here](https://www.youtube.com/watch?v=XjW3t-qXAiE))
