...
# **Y**ODAs **O**rganigam on **D**ata **A**nalysis <sup>1</sup>
...
.footnote[
<sup>1</sup> a [ recursive acronym](https://en.wikipedia.org/wiki/Recursive_acronym)
]
...
- A short talk on YODA principles (see [details](https://github.com/myyoda/talk-principles))
