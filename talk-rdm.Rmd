...
- FDM aus Sicht eines Forschenden
...
- Reproduzierbarkeit ist sehr anspruchsvoll für komplexe Forschungsprojekte
...
# Challenge: Interactions between data and code
...
.pull-left[
```{r, echo=FALSE, fig.align="center", out.width="70%", fig.retina=1, fig.cap='<a href="http://phdcomics.com/comics/archive/phd101212s.gif" target="_blank"><sup>&copy; Jorge Cham (phdcomics.com)</sup></a>'}
knitr::include_graphics("http://phdcomics.com/comics/archive/phd101212s.gif") 
```
]

.pull-right[
- It worked when I ran it last time!
...
# Workflow: Data sharing using MPS infrastructure
<!--the next --- is a horizontal line-->
...
.center[
```{r, echo=FALSE, fig.align="center", out.width="53%", fig.retina=1, fig.cap='see <a href="http://handbook.datalad.org/en/latest/basics/101-138-sharethirdparty.html" target="_blank">DataLad Handbook: Beyond shared infrastructure</a>'}
...
# Project management next to your code and data
...
#### Science as distributed, open-source ~~software~~ *knowledge* development (cf. McElreath, 2020)
