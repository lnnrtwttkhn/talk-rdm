...
knitr::include_graphics(file.path(path_images, "jon_claerbout_headshot.jpg")) 
```
]
...
knitr::include_graphics(file.path(path_images, "turing_way_reproducible_matrix.jpg")) 
```
...
knitr::include_graphics(file.path(path_images, "turingway_scriberia_research_cycle.jpg")) 
```
