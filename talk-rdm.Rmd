...
> How can we conduct our research openly and reproducibly?
...
... and reproducible we may be! `r emoji::emoji("sparkles")`
...
.pull-left[
```{r, echo=FALSE, fig.align="center", out.width="85%", fig.retina=1, fig.cap='<a href="https://schucklab.gitlab.io/" target="_blank">MPRG NeuroCode at MPIB</a>'}
knitr::include_graphics("https://schucklab.gitlab.io/img/digital_group_photo.webp")
```
]
...
> *"If your solution to some problem relies on “If everyone would just…” then you do not have a solution. Everyone is not going to just. At not time in the history of the universe has everyone just, and they’re not going to start now."* -- [Source](https://squareallworthy.tumblr.com/post/163790039847/everyone-will-not-just)
