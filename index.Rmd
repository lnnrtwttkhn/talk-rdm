...
You can find the GitHub repo with all the source code [here](https://github.com/lnnrtwttkhn/talk-rdm).
...
For questions, please contact me via [email](mailto:wittkuhn@mpib-berlin.mpg.de).
Thanks!
